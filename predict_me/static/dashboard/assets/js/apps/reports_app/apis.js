...
// this function will fetch all cities that store in the db
function fetchCities() {
    return $.ajax({
        url: webSiteUrl + "/dashboard/reports/api/cities",
        beforeSend: function (xhr, settings) {
            xhr.setRequestHeader("X-CSRFToken", getCookie('csrftoken'));
        },
        method: "POST",
...
// this function will fetch all Jobs title
function fetchJobsTitles() {
    return $.ajax({
        url: webSiteUrl + "/dashboard/reports/api/jobs",
        beforeSend: function (xhr, settings) {
            xhr.setRequestHeader("X-CSRFToken", getCookie('csrftoken'));
        },
        method: "POST",
